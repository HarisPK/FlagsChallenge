package com.haris.flagschallenge.repository

import com.google.gson.Gson
import com.haris.flagschallenge.models.Question
import com.haris.flagschallenge.models.QuestionsResponse
...
class FlagsRepository {
    ...
    fun getQuestions(): Flow<List<Question>> = flow {
        ...
        val response = gson.fromJson(jsonString, QuestionsResponse::class.java)
